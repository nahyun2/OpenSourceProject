...
VALUES('제목입니다', '내용입니다','2024-10-30 00:13', 0 ,0 ,0 , 'email@email.com');
...
VALUES ('반갑습니다','2024-10-30 00:13','email@email.com', 1);
...
*
FROM board_list_view
WHERE write_datetime BETWEEN '2024-10-24 00:00' AND '2024-10-31 00:00'
