...
export default function Authentication() {
    ...
    const SignUpCard = () => {
      ...
      const onAdressDetailChangeHandler = (event:ChangeEvent<HTMLInputElement>) => {
        const { value } = event.target;
            ...
            <div className='auth-card-top'>
              ...
              {page === 2 && (
                <>
                  ...
                  <InputBox ref={addressDetailRef} label='상세 주소' type='text' placeholder='상세 주소를 입력해주세요.' value={addressDetail} onChange={onAdressDetailChangeHandler} error={false} onKeyDown={onAddressDetailKeyDownHandler} />
                </>
              )}
            </div>
            <div className='auth-card-bottom'>
        ...
        <div className='auth-jumbotron-box'>
          <div className='auth-jumbotron-contents'>
            ...
            <div className='auth-jumbotron-text-box'>
              ...
              <div className='auth-jumbotron-text'>{'WELLBeingHub 입니다.'}</div>
            </div>
          </div>
        </div>
